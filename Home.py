...
st.markdown('Rank of momentum factor is the ordering from lowest to highest, where the cryptocurrency with the lowest momentum value will have a rank of 1')
...
st.markdown('----')
st.markdown('# Page Rank Momentum based Investment ')
st.markdown('Visualizations depicting the relationship between return and momentum factors in rank momentum-based investment')

st.markdown('----')
st.markdown('# Page Volatility and InformationRatio ')
st.markdown('Shows volatility and information ratio of rank momentum-based investment')

st.markdown('----')
st.markdown('# Page Rank ')
st.markdown('Ranking of momentum factors of cryptocurrencies')
